...
urlpatterns = patterns(
    ...
    url(_(r'^account/password/reset/$'), 'django.contrib.auth.views.password_reset', {'template_name': 'account/password_reset_form.html', 'email_template_name': 'account/emails/password_reset_email.txt'}, name='password_reset'),
