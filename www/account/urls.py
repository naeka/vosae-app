...
urlpatterns = patterns(
    ...
    url(_(r'^account/password/reset/$'), views.password_reset, {'template_name': 'account/password_reset_form.html','subject_template_name': 'account/emails/password_reset_subject.txt' ,'email_template_name': 'account/emails/password_reset_email.txt', 'html_email_template_name': 'account/emails/password_reset_email.html'}, name='password_reset'),
