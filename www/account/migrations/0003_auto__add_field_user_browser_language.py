...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.browser_language'
        db.add_column(u'account_user', 'browser_language',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=5, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'User.browser_language'
        db.delete_column(u'account_user', 'browser_language')
    ...
    models = {
        ...
        'account.user': {
            ...
            'browser_language': ('django.db.models.fields.CharField', [], {'max_length': '5', 'blank': 'True'}),
