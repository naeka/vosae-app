...
DELETE RULES
"""
DownPaymentInvoice.register_delete_rule(Quotation, 'down_payments', PULL)
Invoice.register_delete_rule(Quotation, 'related_invoice', NULLIFY)
Quotation.register_delete_rule(Invoice, 'related_quotation', NULLIFY)
